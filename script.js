...
// Lógica del Panel de Contacto (Sutil)
const contactToggle = document.getElementById('contactToggle');
const contactContent = document.getElementById('contactContent');
const floatingDiscord = document.getElementById('floatingDiscord'); // Nuevo elemento JS

contactToggle.addEventListener('click', () => {
    contactToggle.classList.toggle('active');
    contactContent.classList.toggle('active');
    
    // Mostramos el botón flotante con la animación tipo "pop" 😏🧐
    floatingDiscord.classList.add('visible');
});
