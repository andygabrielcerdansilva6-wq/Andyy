...
// 3. NUEVA Lógica de Colaboraciones
const btnColab = document.getElementById('colabToggle');
const panelColab = document.getElementById('colabContent');
btnColab.addEventListener('click', () => {
    btnColab.classList.toggle('active');
    panelColab.classList.toggle('active');
});
